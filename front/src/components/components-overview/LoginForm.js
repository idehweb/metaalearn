              ...
              <Col>
                <Form onSubmit={this.savePasswordAndData}>
                  <Row form>
                    ...
                    <Col md="12" className="form-group">
                      <label htmlFor="ollastname">{t('Your last name')}<span className={'require-star'}>(*)</span></label>
                    ...
                    {registerExtraFields && registerExtraFields.map((item) => {
                      if (item?.name == 'internationalCode') {
                        ...
                        return <Col md="12" className="form-group">
                          <label htmlFor="ollastname">{item?.label}{item?.require && <span className={'require-star'}>(*)</span>}</label>
