...
const GameRound = lazy(() => import('@/views/GameRound'));
const RoundLevelPage = lazy(() => import('@/views/GameRoundLevel'));
...
const DefaultRoute = [
  ...
  {
    path: '/game/:gameId/round/:roundId/level/:levelId',
    element: RoundLevelPage,
    layout: DefaultLayout,
    exact: true,
  },
  {
